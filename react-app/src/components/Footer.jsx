    ...
    return (
      <footer className= " text-center py-3 mt-auto">
        <div className="container">
          <footer className="d-flex flex-wrap justify-content-between align-items-center pt-4 border-top">
            <div className="col-md-5 d-flex align-items-center">
              <a href="/" className="mb-3 me-2 mb-md-0 text-body-secondary text-decoration-none lh-1">
              </a>
              <span className="mb-1 mb-md-0 text-body-secondary" style={{fontSize: "large"}}>© 2024 Athena Automation. All Rights Reserved</span>
            </div>
